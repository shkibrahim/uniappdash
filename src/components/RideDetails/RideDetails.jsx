      ...
      <div className="relative p-4 md:p-9 bg-white rounded-lg flex flex-col items-center overflow-auto gap-7 md:w-[480px] ">
        ...
        <div className="flex shadow-custom py-3 px-5 flex-col rounded-md w-full">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <div className="flex flex-col">
                <span className="text-xl font-semibold">Feb 27, 2024</span>
          ...
          <div className="flex gap-3 mt-5 flex-wrap">
            <div className="flex gap-2 items-center py-1 px-3 bg-[#FFB0004D] rounded-3xl border-2 border-[#ce94194d] font-semibold shadow-custom text-xl">
              <FaUser />
              <span>Private</span>
            </div>
            <div className="flex gap-2 items-center py-1 px-3 bg-[#FFB0004D] rounded-3xl border-2 border-[#ce94194d] font-semibold shadow-custom text-xl">
