...
import Total from "../../assets/img/totaluser.svg";
import Drivers from "../../assets/img/driver.svg";
    ...
    <div className="sm:m-6 m-4 md:m-10">
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:gap-4">
        <div className=" p-2 pl-8 my-2 md:my-4 md:pr-12 border-2 border-gray-100 shadow-md shadow-gray-300 rounded-md">
          <div className="flex space-x-5 items-center justify-center">
            <div className="bg-gray-200 flex items-center justify-center rounded-full h-[56px] w-[56px]">
              {/* <Earnings color={"#FFB000"} size={20} /> */}
              <img src={Earning} alt="" />
            </div>
            <div>
              <div className="font-dmsans text-sm text-[#A3AED0]">Earnings</div>
              <div className=" font-dmsans sm:text-lg md:text-2xl   text-[#48525B] font-semibold">
                $350.4
              </div>
            </div>
          </div>
        ...
        <div className=" p-2 pl-8 my-2 md:my-4 pr-12 border-2 border-gray-100 shadow-md shadow-gray-300 rounded-md">
          <div className="flex space-x-5 items-center justify-center">
            <div className="bg-gray-200 flex items-center justify-center rounded-full h-[56px] w-[56px]">
              {/* <Users color={"#FFB000"} size={20} /> */}
              <img src={Total} alt="" />
            </div>
            <div>
              <div className="font-dmsans text-sm text-[#A3AED0]">
                Total Users
              </div>
              <div className="   font-dmsans sm:text-lg md:text-2xl   text-[#48525B]  font-semibold">
                1200
      ...
      <div className="sm:mt-8 mt-6 md:mt-10 flex  justify-between  items-center ">
        <div className="flex items-center space-x-4 md:space-x-8">
          ...
          <div className="relative">
            <IoIosArrowDown
              ...
              className={`text-[#48525B] text-sm md:text-base ${
            ...
            {showTimeFrame && (
              <div className="absolute -bottom-56 z-50 -right-40 md:-right-32 flex flex-col shadow-custom bg-white p-3 items-center justify-center w-auto rounded-md gap-4">
                <h2 className="sm:text-base text-sm font-primary text-[#00261C] md:text-xl">
                  Select time frame
                </h2>
                <div className="flex gap-3 items-center">
                  <h2 className=" font-primary  text-[#00261C] font-semibold w-10">
                    From
                  </h2>
                  <select
                    name="month"
        ...
        <div className="flex  space-x-4 md:space-x-8 items-center ">
          <div className="flex space-x-1 md:space-x-2 items-center">
            ...
            <div className="text-xs sm:text-base text-[#48525B] font-inter">
              Last 6 months
            </div>
          </div>
          <div className="flex md:space-x-2 space-x-1 items-center">
            ...
            <div className="text-xs text-[#48525B] font-inter sm:text-base">
      ...
      <div className="flex items-center mt-4 space-x-4 md:space-x-8 font-Manrope">
        ...
        <div className="flex items-center  space-x-2 text-sm sm:text-base  md:text-lg">
          <div className=" text-primary  font-semibold font-primary">
            6% than last month
          </div>
      ...
      <div className=" my-10  grid md:grid-cols-[3fr_1fr] gap-x-4">
        ...
        <section
          id="stats "
          className="border-2 my-4 border-gray-200 shadow-lg shadow-gray-200 py-4 rounded-xl  "
        >
          <div className=" flex items-center justify-center space-x-2 sm:space-x-4 md:space-x-3 font-primary">
              ...
              return (
                <li key={index} className="mb-8">
                  <ul className="flex flex-col items-center space-y-1">
                    ...
                    <li className=" text-[#48525B] sm:text-base text-sm md:text-[24px] font-semibold ">
                      {item?.value}
                    </li>
                  </ul>
                </li>
        ...
        <section className="">
          <div className="flex flex-col items-center border-2 border-gray-200 shadow-lg shadow-gray-200 p-2 px-8 rounded-xl space-y-8 font-Manrope">
            <div className="flex flex-col items-center">
              <div className="flex flex-col items-center -space-y-1">
                <div className="text-2xl font-semibold text-[#48525B]">
                  Success Rate
                </div>
          ...
          <div className="flex flex-col mt-5 items-center border-2 border-gray-200 shadow-lg shadow-gray-200 p-2 px-8 rounded-xl space-y-8 font-Manrope">
            <div className="flex flex-col  space-y-4 items-center">
              <div className="text-xl text-[#48525B] font-primary font-semibold">
                Average Ratings
              </div>
              ...
              <div className="flex justify-between   w-[150px] ">
                <div className="flex items-center">
                  <div className="flex flex-col -space-y-2 items-center">
                    ...
                    <div className=" font-semibold text-lg text-[#48525B]">
                      4.7
                    </div>
                  </div>
                </div>
      ...
      <div className="my-12  md:gap-x-8  md:grid grid-cols-2 font-Manrope ">
        <div className="">
          <div class="relative overflow-x-auto md:m-0 my-4 bg-white shadow-lg  rounded-xl p-2 ">
            <div className="flex justify-between ">
              <div className="text-xl font-semibold font-primary  text-[#48525B]">
                Top Drivers
              </div>
              <div>
                ...
                {topDrivers?.map((item, index) => {
                  return (
                    <tr key={index} className=" ">
                      ...
                      <td className="text-[#48525B]  font-primary font-semibold text-sm px-6 py-4">
                        {item?.name}
                      </td>
                      <td className="text-[#48525B]  font-primary font-semibold text-sm px-6 py-4">
                        {item?.earnings}
                ...
                {topDrivers?.map((item, index) => {
                  return (
                    <tr key={index} className=" ">
                      ...
                      <td className="px-6 py-4 text-[#48525B]  font-primary font-semibold text-sm">
                        {item?.name}
                      </td>
                      <td className="px-6 py-4 text-[#48525B]  font-primary font-semibold text-sm">
                        {item?.earnings}
