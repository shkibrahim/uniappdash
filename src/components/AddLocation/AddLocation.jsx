...
const AddLocation = ({ setTrigger }) => {
  return (
    <div className="fixed flex h-screen w-full items-center justify-center bg-black bg-opacity-75 top-0 left-0   z-50">
      <div className="  overflow-auto  flex flex-col bg-white p-4 rounded-md relative   items-center justify-center">
        <div
        ...
        <form action="" className="flex flex-col gap-1">
          ...
          <div className="flex gap-3">
            <div className="flex px-3 py-2 bg-gray-100 rounded-3xl border-2 border-solid border-primary gap-2 font-semibold">
          ...
          />
          <div className="relative h-[162px] w-[387px]">
